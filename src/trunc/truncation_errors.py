...
class DiffOp:
    ...
    def __init__(self, f, independent_variable='x',
        ...
        self.h = sm.Symbol('d%s' % independent_variable)
        ...
        self.diffops = {diffop: sm.simplify(self.diffops[diffop])
...
def truncation_errors():
    ...
    print 'R arithmetic mean:', diffop['weighted_arithmetic_mean'].subs(theta, sm.Rational(1,2)) - u
