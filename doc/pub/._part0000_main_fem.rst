...
.. math::
        ...
        u(x) = \sum_{j\in{I_b}} U_j{\varphi}_j(x) + \sum{j\in{\mathcal{I}_s}}c_j{\varphi}_{\nu(j)},
...
.. math::
   :label: fem:deq:diffu:Dirichlet:ex:pde
        ...
        u_t = ({\alpha} u_x)_x + f,\quad  \boldsymbol{x}\in\Omega =[0,L],\ t>0,
