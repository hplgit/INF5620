...
.. :ref:`(2.10) <Eq:wave:pde1:step4>`

for :math:`i=0`,


.. _Eq:wave:pde1:Neumann:0:scheme:
...
.. figure:: mov-wave/wave1D_PDE_Neumann_stencil_gpl/stencil_n_left.png
   :width: 500
...
or a `movie file <http://tinyurl.com/k3sdbuv/pub/mov-wave/wave1D_PDE_Neumann_stencil_gpl/movie.ogg>`_.
...
Our next generalization of the 1D wave equation :ref:`(2.1) <Eq:wave:pde1>` or
:ref:`(2.12) <Eq:wave:pde2>` is to allow for a variable wave velocity :math:`c`:
...
.. _Eq:wave:pde2:var:c:formula:op:
...
.. _Eq:wave:pde2:var:c:mean:arithmetic:
...
.. _Eq:wave:pde2:var:c:mean:harmonic:
...
.. _Eq:wave:pde2:var:c:mean:geometric:
...
.. _Eq:wave:pde2:var:c:scheme:impl:
...
.. _Eq:wave:pde2:var:c:scheme:impl:Neumann:
...
.. _Eq:wave:pde2:var:c:scheme:impl:Neumann2:
...
**Hint.**
Symmetry of a function about :math:`x=x_0` means that
...
**b)**
Switch to :math:`q(x)=\cos(\pi x/L)`, which is symmetric at :math:`x=0,L`,
