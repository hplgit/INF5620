...
Exercise 1: Visualize the accuracy of finite differences :math:`u=e^{-at}`
--------------------------------------------------------------------------
...
**a)**
Run experiments with :math:`\theta=0, 0.5, 1` for various values of :math:`\Delta
...
taken as a stability criterion.

Use the insight to select a few values of :math:`\Delta t` and :math:`a` fixed that
