...
problem  :eq:`vib:ode1` we follow the `four steps <http://hplgit.github.com/INF5620/doc/pub/decay-sphinx/main_decay.html#the-forward-euler-scheme>`_ in [Ref1]_.
...
(see 
`examples <http://hplgit.github.com/INF5620/doc/pub/decay-sphinx/main_decay.html#compact-operator-notation-for-finite-differences>`_ in [Ref1]_). The difference :eq:`vib:ode1:step3` has the operator
...
schemes <http://hplgit.github.io/INF5620/doc/pub/decay-sphinx/._part0007_main_decay.html#example-adaptive-runge-kutta-methods>`_
...
for an `ODE model <http://hplgit.github.com/INF5620/doc/pub/decay-sphinx/main_decay.html#implementing-simple-problem-and-solver-classes>`_.
