...
The characteristics of the displayed curves can be summarized as follows:
  ...
  * The Backward Euler scheme always give a monotone solution, lying above
    the exact curve.
...
<function admon at 0x2438578>('notice', 'Solving difference equations', r"""
...
Exercise 9: Visualize the accuracy of finite differences :math:`u=e^{-at}`
--------------------------------------------------------------------------
...
Exercise 10: Explore the :math:`\theta`-rule for exponential growth
-------------------------------------------------------------------
